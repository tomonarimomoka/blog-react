...
export const Hakkason_2: FC = () => {
  const hello_world = `import streamlit as st
st.write("Hello world")`
  const prompt = `以下の手順で、記事の内容をポジティブにしてください。記事の内容を要約してはいけません。Let's think step by step.
  【手順1】
  ...
  return(
    ...
    <ol>
      ...
      <li>
        ...
        <SourceCode>{hello_world}</SourceCode>
      </li>
      <li>
        Pythonプログラムの実行<br/>
